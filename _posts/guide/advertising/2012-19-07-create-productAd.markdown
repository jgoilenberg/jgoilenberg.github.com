...
One ways of creating a product Ad is to send the encoded bytes of an image with the "fileInput" attribute in the request plus all the necessary data to create it.
